...
const adrenaline = {
    ...
    monstre: {
        ...
        description:
            'Create an Adrenaline creature card with named-state and contagion data.',
        ...
        form: {
            ...
            baseState: 'Base profile',
            stateId: 'State ID',
            addState: 'Add state',
            newStateName: 'New state',
            newTrigger: 'New trigger',
            trigger: 'Trigger',
            duplicateStateId: 'Each state ID must be unique.',
            invalidState: 'This state does not match the Adrenaline schema.',
            triggers: 'Triggers',
