...
type Item<Value> = NonNullable<Value> extends readonly (infer Entry)[] ? Entry : never
type Meta<Document extends { meta?: unknown }> = NonNullable<Document['meta']>

export type CityCustomMovePublicationType = Meta<CityOfMistCustomMove>['publication_type']
...
export type CityDangerPublicationType = Meta<CityOfMistDanger>['publication_type']
export type CitySpectrum = Omit<Item<CityOfMistDanger['spectrums']>, 'is_countdown'> & { is_countdown?: boolean }
export type CityDangerCustomMove = Item<CityOfMistDanger['custom_moves']>
export type CityDangerMeta = Meta<CityOfMistDanger>

export type CityCardPublicationType = Meta<CityOfMistThemeCard>['publication_type']
export type CityCardThemeType = CityOfMistThemeCard['theme_type']
export type CityErosionKind = NonNullable<CityOfMistThemeCard['erosion']>['kind']
export type CityMotivationKind = NonNullable<CityOfMistThemeCard['motivation']>['kind']
...
export type CityKitPublicationType = Meta<CityOfMistThemeKit>['publication_type']
export type CityKitThemeType = CityOfMistThemeKit['theme_type']
export type CityKitMotivationKind = NonNullable<CityOfMistThemeKit['motivation']>['kind']
export type CityCrewOutcome = Item<CityOfMistThemeKit['crew_relationships']>['outcome']
export type CityQuestion = Item<CityOfMistThemeKit['power_tag_questions']>
export type CitySelectionRule = NonNullable<CityOfMistThemeKit['power_tag_rule']>
export type CityKitMotivation = NonNullable<CityOfMistThemeKit['motivation']>
export type CityCrewRelationship = Item<CityOfMistThemeKit['crew_relationships']>
...
export type LitmChallengePublicationType = Meta<LegendInTheMistChallenge>['publication_type']
...
export type LitmSpecialFeature = Item<LegendInTheMistChallenge['special_features']>
...
export type LitmJourneyPublicationType = Meta<LegendInTheMistJourney>['publication_type']
...
export type LitmStoryPublicationType = Meta<LegendInTheMistStoryTheme>['publication_type']
export type LitmStoryThemeMeta = Meta<LegendInTheMistStoryTheme>

export type LitmKitPublicationType = Meta<LegendInTheMistThemeKit>['publication_type']
...
export type OsChallengePublicationType = Meta<OtherscapeChallenge>['publication_type']
...
export type OsTropePublicationType = Meta<OtherscapeCharacterTrope>['publication_type']
...
export type OsLoadoutPublicationType = Meta<OtherscapeLoadoutItem>['publication_type']
export type OsLoadoutItemMeta = Meta<OtherscapeLoadoutItem>

export type OsPowerSetType = OtherscapePowerSet['type']
export type OsPowerPublicationType = Meta<OtherscapePowerSet>['publication_type']
...
export function carryCanonicalSource<Form extends object, Canonical extends object>(
    form: Form,
    source: Canonical
): Form {
...
export function overlayCanonicalSource<Form extends object, Owned extends object = Form>(
    form: Form,
    owned: Owned = form as unknown as Owned
): Owned {
