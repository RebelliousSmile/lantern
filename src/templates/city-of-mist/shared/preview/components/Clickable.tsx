...
/* Every City card edits the same way: the region you want to change is the
   button. These live here rather than in one template because the City
   documents all print regions and rows, and a copy per template would drift the
   hover affordance apart card by card. */
export function ClickableSection({
    ...
    return (
        <div className="relative group">
            ...
            {/* Hover wash. The City card is parchment, so a region darkens on
                hover the way the Danger's does; the :Otherscape pair this was
                copied from lightens instead, which only reads on their
                near-black slab. */}
            <div
