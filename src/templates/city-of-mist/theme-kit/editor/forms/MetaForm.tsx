...
import { useCityOfMistThemeKitStore, type PublicationType } from '../../hooks'
...
export default function MetaForm() {
    const { cityOfMistThemeKit, updateMeta } = useCityOfMistThemeKitStore()
    ...
    return (
        <div className="space-y-4">
            ...
            {sources.length ? (
                <div className="grid gap-1">
                    <Label htmlFor="theme-kit-catalog-source">
                        Catalog source
                    </Label>
                    <select
                        id="theme-kit-catalog-source"
            ...
            <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_110px] sm:items-end">
                <div className="grid gap-1">
                    <Label htmlFor="theme-kit-meta-source">
                        Source{' '}
                ...
                <div className="grid gap-1">
                    <Label htmlFor="theme-kit-meta-page">
                        Page{' '}
                        <span className="text-muted-foreground">
                            (optional)
                        </span>
