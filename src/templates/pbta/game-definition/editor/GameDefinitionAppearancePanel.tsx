    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between gap-4">
                <Label htmlFor="pbta-def-auto-hide-empty" className="text-xs">
                    Auto-hide empty sections
                </Label>
                <Switch
                    id="pbta-def-auto-hide-empty"
            ...
            <div className="flex items-center justify-between gap-4">
                <Label htmlFor="pbta-def-separators" className="text-xs">
                    Show separators
                </Label>
                <Switch
                    id="pbta-def-separators"
            ...
            <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-x-3 gap-y-1.5">
                    {gameDefinitionSections.map((section) => (
                        <label
                            key={section.id}
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between gap-2">
                    <Label htmlFor="pbta-def-preview-width" className="text-xs">
                        Preview width
                    </Label>
