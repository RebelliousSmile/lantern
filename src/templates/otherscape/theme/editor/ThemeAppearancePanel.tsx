...
import { useOtherscapeThemeViewStore } from '../hooks'
import { themeBackgroundOptions, themeSections } from '../metadata'
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between gap-4">
                <Label htmlFor="os-theme-auto-hide-empty" className="text-xs">
                    Auto-hide empty sections
                </Label>
                <Switch
                    id="os-theme-auto-hide-empty"
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between gap-2">
                    <Label htmlFor="os-theme-preview-width" className="text-xs">
                        Preview width
                    </Label>
            ...
            <div className="space-y-2">
                ...
                >
                    {themeBackgroundOptions.map((option) => (
                        <label
                            key={option.value}
                            className="flex cursor-pointer items-center gap-2"
                        >
                            <RadioGroupItem
                                value={option.value}
                                id={`os-theme-background-${option.value}`}
                            />
