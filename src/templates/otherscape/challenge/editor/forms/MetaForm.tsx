...
import { useOtherscapeChallengeStore, type PublicationType } from '../../hooks'
...
export default function MetaForm() {
    const { otherscapeChallenge, updateMeta } = useOtherscapeChallengeStore()
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_110px] sm:items-end">
                <div className="grid gap-1">
                    <Label htmlFor="os-challenge-meta-source">
                        {type === 'cauldron'
                ...
                <div className="grid gap-1">
                    <Label htmlFor="os-challenge-meta-page">
                        Page{' '}
                        <span className="text-muted-foreground">
                            (optional)
                        </span>
