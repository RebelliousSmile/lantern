...
/* ----------------------------------------------------------------------------
   ...
   The card's general consequences belong to the Challenge rather than to any
...
export default function ThreatsEditor({
    ...
    useEffect(() => {
        if (
            ...
            otherscapeChallenge.threats[focusIndex]
        ) {
    ...
    function uniqueThreatName() {
        ...
        const used = new Set(
            otherscapeChallenge.threats.map((t) => (t.name || '').toLowerCase())
        )
    ...
    function addThreatPlaceholder() {
        ...
        const idx = otherscapeChallenge.threats.length
    ...
    function startEditThreat(idx: number) {
        const t = otherscapeChallenge.threats[idx]
        if (!t) return
        setEditingThreat(idx)
        setTName(t.name || '')
    ...
    function addConsequencePlaceholder() {
        ...
        const idx = (
            otherscapeChallenge.threats[currentThreatIndex].consequences ?? []
        ).length // end
        setEditingCons(idx)
                    ...
                    <div className="w-full pr-2 min-w-0">
                        ...
                        >
                            <ul className="space-y-2">
                                {otherscapeChallenge.threats.map((t, tIdx) => {
                                                ...
                                                <div className="mt-2 space-y-2.5 rounded-md border bg-muted/30 p-2.5">
                                                    ...
                                                    <div className="grid gap-1">
                                                        ...
                                                        <Textarea
                                                            ...
                                                            placeholder={`What the ${noun.toLowerCase()} starts to do…`}
                                                        />
                                                    </div>
