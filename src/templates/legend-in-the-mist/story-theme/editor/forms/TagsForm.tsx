...
import { useLegendInTheMistStoryThemeStore, type TagField } from '../../hooks'
...
const PLACEHOLDERS: Record<TagField, string[]> = {
    ...
    weakness: ['they still expect me back', 'owes a debt', 'too easily moved'],
}
                                ...
                                {editingIndex === index && (
                                    <div className="mt-2 space-y-2.5 rounded-md border bg-muted/30 p-2.5">
                                        ...
                                        <div className="grid gap-1">
                                            <Label
                                                htmlFor={`story-theme-tag-${field}-${index}`}
                                                className="text-xs"
                                            >
                                                Tag
                                            </Label>
                                            <Input
                                                id={`story-theme-tag-${field}-${index}`}
                                                ...
                                                placeholder="knows every face in town"
                                            />
                                        </div>
